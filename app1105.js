...
server.get({path:'/bulk1',version : '0.0.1'}, function(req, res, next){
		...
		collection.insert({insertOne:logmsg0},function(err,result){if(err) console.log('bulk1 err0');});
		collection.insert({insertOne:logmsg1},function(err,result){if(err) console.log('bulk1 err1');});
		collection.insert({insertOne:logmsg2},function(err,result){if(err) console.log('bulk1 err2');});
		collection.insert({insertOne:logmsg3},function(err,result){if(err) console.log('bulk1 err3');});
		collection.insert({insertOne:logmsg4},function(err,result){if(err) console.log('bulk1 err4');});
		collection.insert({insertOne:logmsg5},function(err,result){if(err) console.log('bulk1 err5');});
		collection.insert({insertOne:logmsg6},function(err,result){if(err) console.log('bulk1 err6');});
		collection.insert({insertOne:logmsg7},function(err,result){if(err) console.log('bulk1 err7');});
		collection.insert({insertOne:logmsg8},function(err,result){if(err) console.log('bulk1 err8');});
		collection.insert({insertOne:logmsg9},function(err,result){if(err) console.log('bulk1 err9');});
		...
		collection.insert({insertMany:[	
			...
			logmsg7,
			logmsg8,
			logmsg9]},{forceServerObjectId:true},function(err, result) {
